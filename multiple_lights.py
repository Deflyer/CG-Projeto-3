...
def main() -> int:
    ...
    # ------------------------------------------------------------------
    # Uso do exemplo:
    vertices = load_obj_to_glm_array('./texturas/untitled.obj')
    ...
    # -----------------------------------------------------------------------------
    diffuseMap = loadTexture("jureg.jpg")
    #specularMap = loadTexture("drawer_texture.png")
    ...
    while (not glfwWindowShouldClose(window)):
        ...
        lightingShader.setVec3("pointLights[0].ambient", 0.1, 0.0, 0.0)  # Luz ambiente em vermelho
        lightingShader.setVec3("pointLights[0].diffuse", 1.0, 0.0, 0.0)  # Luz de difusão em vermelho
        lightingShader.setVec3("pointLights[0].specular", 1.0, 0.5, 0.5) # Luz especular com brilho vermelho-rosado
        ...
        lightingShader.setVec3("spotLight.diffuse", 0, 1.0, 0)
